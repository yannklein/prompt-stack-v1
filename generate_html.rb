  ...
  response = client.chat(
    parameters: {
      ...
      messages: [
        ...
        { role: "user", content: "The website has to have some Javascript code that change image size, position and rotation when we click and/or hover on them, add this Javascript code to the HTML file inside <script> tags." },
